...
def main():
    ...
    user_input = st.text_area(
        "Please paste the text you want to summarize below:",
        height=200
    )
    ...
    if st.button("Generate Summary"):
        if user_input.strip():
            ...
            prompt = f"""
            Summarize the following text into a concise and clear summary:

            "{user_input}"

            The summary should capture the main points and be suitable for a general audience.
            """
